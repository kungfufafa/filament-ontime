...
class AttendanceResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'check_in_photo' => $this->check_in_photo ? (config('filesystems.default') === 's3' ? Storage::disk('s3')->temporaryUrl($this->check_in_photo, now()->addMinutes(60)) : Storage::disk(config('filesystems.default'))->url($this->check_in_photo)) : null,
