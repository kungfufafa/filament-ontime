...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <?php else: ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($policy?->require_face_recognition && empty($profile->master_face_photo)): ?>
            ...
            <div class="md:col-span-1 p-6 bg-white dark:bg-gray-900 shadow-sm border border-gray-200 dark:border-gray-800 rounded-xl">
                ...
                <div class="mt-4 space-y-3 text-sm text-gray-600 dark:text-gray-400">
                    <div>
                        ...
                        <span class="font-medium text-gray-900 dark:text-white"><?php echo e($profileName); ?> <span class="text-xs text-gray-500">(<?php echo e($tipeLabel); ?>)</span></span>
                    </div>
                    <div>
                        <span class="block text-xs font-medium text-gray-500">ID / NIP & Badan Usaha</span>
                        <span class="font-medium text-gray-900 dark:text-white"><?php echo e($profileNip); ?> (<?php echo e($profileCompany); ?>)</span>
                    </div>
                    <div>
                        <span class="block text-xs font-medium text-gray-500">Jam Masuk & Toleransi</span>
                        <span class="font-medium text-gray-900 dark:text-white"><?php echo e($policy?->work_start_time ?? '08:00'); ?> (Toleransi <?php echo e($policy?->late_tolerance_minutes ?? 15); ?> menit)</span>
                    </div>
                    <div>
                        ...
                        <div class="mt-1 flex flex-wrap gap-2">
                            <span class="px-2 py-0.5 text-xs rounded bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300">
                                Foto: <?php echo e($policy?->require_photo ? 'Wajib' : 'Opsional'); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\AHTAR\filament-ontime\resources\views/filament/pages/absen-hari-ini.blade.php ENDPATH**/ ?>