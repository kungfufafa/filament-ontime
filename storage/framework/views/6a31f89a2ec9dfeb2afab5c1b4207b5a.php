...
<div x-data="{
    photoPath: $wire.entangle('<?php echo e($getStatePath()); ?>'),
    previewUrl: null,
    activeTab: 'camera',
    uploading: false,
    cameraActive: false,
    ...
    uploadFormData(formData) {
        ...
        .then(async (res) => {
            ...
            if (data && data.success) {
                ...
                $wire.set('<?php echo e($getStatePath()); ?>', data.path);
                this.stopCamera();
            } else {
    ...
    resetPhoto() {
        ...
        this.photoPath = null;
        $wire.set('<?php echo e($getStatePath()); ?>', null);
...
class="space-y-3">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = [$getStatePath()];
    ...
    <template x-if="photoPath">
        <div class="space-y-3 text-center">
            <div class="relative w-44 h-44 mx-auto rounded-full overflow-hidden border-4 border-emerald-500/80 shadow-lg bg-gray-100 dark:bg-gray-800 flex items-center justify-center">
                ...
                ?>
                <img :src="previewUrl || '<?php echo e($initialUrl); ?>'"
...
<?php /**PATH C:\Users\AHTAR\filament-ontime\resources\views/filament/components/master-face-capture.blade.php ENDPATH**/ ?>